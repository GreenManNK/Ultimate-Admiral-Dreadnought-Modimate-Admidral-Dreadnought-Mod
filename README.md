...
- New-campaign major-nation starts are written into `resources.assets`: shipyard start 15,000,000 tons and base income 500B so freshly created campaigns do not revert to vanilla starts.
